                                ...
                                <form method="GET" class="mb-3 d-flex gap-2 flex-wrap" data-auto-filter="true">
                                    <div class="input-group" style="max-width:380px">
                                        <input type="text" name="buscar" class="form-control form-control-sm"
                                               placeholder="Buscar categoría..." value="{{ request('buscar') }}">
                                    ...
                                    <table class="table table-bordered table-hover align-middle">
                                        ...
                                        @forelse($categorias as $categoria)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($categoria->icono)
                                                        <i class="{{ $categoria->icono }} me-1" style="color:{{ $categoria->color ?? '#333' }}"></i>
                                                    @endif
                                                ...
                                                <td>
                                                    <span class="badge {{ $categoria->estado ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-danger-subtle text-danger border border-danger-subtle' }}">
